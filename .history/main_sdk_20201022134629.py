...
# TODO: check http://help.brain-map.org/display/devmouse/API -> are there any expression-levels without structureid as well?
# TODO: other databases for mice gene expression, preferably using in-situ hybridization. detailed microarray or sequencing would also be ok.