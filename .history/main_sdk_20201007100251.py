...
# TODO: we got sagittal and coronal planes for mice. do we need both? for humans, this is not specified (i guess microarray works differently).
# we could use it as an additional dataset for comparison of inter-species and intra-species. clarify with Jure
