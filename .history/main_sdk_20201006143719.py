...
num_samples = len(humanExpressionData["samples"])
...
human = pd.DataFrame(np.column_stack([combined.samples, combined.expression_levels, combined.z_scores ]), 
                               columns=['sample', 'expression_level', 'z-score'])
