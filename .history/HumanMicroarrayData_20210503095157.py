...
class HumanMicroarrayData:
  ...
  def transformExpressionData(self, expressionData):
    ...
    for probe in expressionData["probes"]:
      ...
      combined.expression_levels += probe[Constants.EXPR_LVL]
      combined.z_scores += probe[Constants.Z_SCORE] 
    ...
    data = pd.DataFrame({Constants.EXPR_LVL: combined.expression_levels, Constants.Z_SCORE: combined.z_scores},
