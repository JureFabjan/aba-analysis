...
GENE_LIST = Utils.DropDownListConfiguration(label='Gene', type='gene', default='Gabra4', defaultLeft='Gabra4', defaultRight='Gabrb3', 
...
AGGREGATION_FUNCTIONS = Utils.DropDownListConfiguration(label='Aggregation function', type='aggregation_function', data=['min', 'max', 'mean', 'var'], 
  default='mean', defaultLeft='mean',defaultRight='var')

SPECIES = Utils.DropDownListConfiguration(label=None, type='species', data=['human', 'mouse - sagittal', 'mouse - coronal'], 
  default='human', defaultLeft= 'human', defaultRight= 'mouse - sagittal')

STRUCTURE_LEVELS = Utils.DropDownListConfiguration(label='Level', type='structure_level', data=[l for l in range(0,10)], 
