...
# GABRG2, GABRB2
gabr_b3_a4 = Comparison.merge_coex(human.Gabrb3.data.structure, human.Gabra4.data.structure, ['gabrb3', 'gabra4'], ['structure_name', 'level_3']).reset_index()
...
Visualisation.scatter(Utils.unstack_columns(gabr_b3_a4), 
  ...
  hue="level_3", # hue is very slow when providing many different values. try to keep it coarsly grained, e.g. on larger scaled brain-structures
  legend = True) 
