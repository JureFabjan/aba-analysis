...
class MouseISHData:
  ...
  def get(self, from_cache, aggregations): 
    ...
    if not from_cache:
      ...
      # http://alleninstitute.github.io/AllenSDK/_static/examples/nb/reference_space.html#Downloading-an-annotation-volume
      tree, structure_map = StructureMap(reference_space_key = 'annotation/ccf_2017', resolution=200).get(structure_graph_id=1) # , annotation, meta 
