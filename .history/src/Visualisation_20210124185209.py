...
class WebInterface:
  ...
  def coexpressions(self, aggregation_function, structure_level, species, hemisphere, gene1, gene2):
    structure_level = "level_{}".format(structure_level)
    ...
    return px.scatter(data, x=f"expression_level_{gene1}_{aggregation_function}", y=f"expression_level_{gene2}_{aggregation_function}",
	         size=data[f"shared_{aggregation_function}"], color=structure_level,
           size_max=400)
