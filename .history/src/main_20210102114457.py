...
comp_agg = { agg: comp[[(d, agg) for d in { **column_mappings['human'], **column_mappings['mouse']}.values()]].droplevel(1, axis=1) for agg in aggregations }
...
Visualisation.heatmap(human['data']['acronym'].dropna()[[('z-score', 'var')]], 'var')
