...
SPECIES = Utils.simple({ 'label': 'Species', 'type': 'species', 'defaultLeft': 'human', 'defaultRight': 'mouse', 'data': ['human', 'mouse'], 'fns': { 'human': HumanMicroarrayData, 'rodent': MouseISHData} })
