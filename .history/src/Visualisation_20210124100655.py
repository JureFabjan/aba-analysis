          ...
          dbc.Row([
                dbc.Col([
                  ...
                  dbc.Row(html.Div(dcc.Loading(
                    dcc.Graph(id={ 'type': 'graph', 'view': viewName, 'side': 'left'}, style={'width': '50vw', 'height': '50vw'})
                ...
                dbc.Col([
                  ...
                  dbc.Row(html.Div(dcc.Loading(
                    dcc.Graph(id={ 'type': 'graph', 'view': viewName, 'side': 'right'}, style={'width': '50vw', 'height': '50vw'})
                  )), className="mt-3 w-100")
                ])
          ])
        ]
