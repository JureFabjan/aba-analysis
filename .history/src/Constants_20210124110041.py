...
HEMISPHERES = Utils.simple({ 'label': 'Hemisphere', 'type': 'hemisphere', 'default': 'both', 'data': ['left', 'right', 'both'] })
SPECIES = Utils.simple({ 'label': 'Species', 'type': 'species', 'leftDefault': 'human', 'rightDefault': 'mouse', 'data': ['human', 'mouse'] })
