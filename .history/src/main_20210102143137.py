...
FormattedExport.to_excel(h_by_region, f'export\\human_mean_pivot_agg_{geneAcronym}.xlsx')


Visualisation.heatmap(h_by_region, f'Human - {geneAcronym}, z-score (mean)', 
{ 'left': 0.175, 'bottom': 0.095, 'right': 1, 'top': 0.967, 'wspace': 0.0, 'hspace': 0.0}, {'ylabel': "brain-region"}, 
ylabel="brain-region", xlabel="fine-structure's rank", yticklabels=True)
