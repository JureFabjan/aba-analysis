    ...
    return html.Div([
          ...
          dbc.Row([
                dbc.Col([
                  ...
                  dbc.Row(
                    dbc.Alert("This is a danger alert. Scary!", color="danger", className="ml-3 mr-2 mt-1 w-100"),
                  ),
                ...
                dbc.Col([
                  ...
                  dbc.Row(
                    dbc.Alert("This is a danger alert. Scary!", color="danger", className="ml-2 mr-2 mt-1 w-100"),
                  ),
                  dbc.Row(html.Div(dcc.Loading(
