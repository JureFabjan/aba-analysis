        ...
        [
          dbc.Form(
            dbc.FormGroup([
                ...
                self.dropDownByList(STRUCTURE_LEVELS, 'structure_level', className=defaultClassName), 
                dbc.Label("Aggregation function", html_for="aggregation_function", className=defaultClassName),
                self.dropDownByList(AGGREGATION_FUNCTIONS, 'aggregation_function', className=defaultClassName)
                ])
          , inline=True),
          dbc.Row([
