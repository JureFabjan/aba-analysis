...
# print(coex_b3_a4)
gabr_b3_a4 = Comparison.merge_coex(human.Gabrb3.data.structure, human.Gabra4.data.structure, ['gabrb3', 'gabra4']).reset_index()
gabr_b3_a4['hue'] = gabr_b3_a4[['structure_name']].astype("category")
Visualisation.scatter(Utils.unstack_columns(gabr_b3_a4), 
  x="expression_level_gabra4_mean", 
  y="expression_level_gabrb3_mean", 
  size="expression_level_gabrb3_var", sizes=(40,400), 
  hue="structure_name", legend = True) 
