...
m_by_region = Comparison.by_region(mouse_gabra4[0].data.structure, 'expression_level', 'level_4', 'structure_name')
...
Visualisation.heatmap(m_by_region['mean'], f'Mouse - gabra4, expression_level (mean)', 
  { 'left': 0.175, 'bottom': 0.095, 'right': 1, 'top': 0.967, 'wspace': 0.0, 'hspace': 0.0}, 
  xlabel="fine-structure's rank", ylabel="brain-region", yticklabels=True)
