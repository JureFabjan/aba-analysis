...
# TODOs: 
# match using manually created mapping of anatomical structures, e.g. based on Sequeira-paper and/or https://science.sciencemag.org/content/367/6482/eaay5947/tab-figures-data
...
def by(df1, df2, column):
    c = df1.merge(df2, left_on=column, right_on=column, how="outer").dropna(axis=1, how='all')