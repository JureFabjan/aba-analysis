...
class WebInterface:
  def __init__(self, name, port = 5000):
    ...
    def heatMapsByRegionCallback(agg_function, left_gene, right_gene):
      ...
      return no_update if left_unchanged else heatmapByRegion(**common, **left), no_update if right_unchanged else heatmapByRegion(**common, **right)
      
    def heatmapByRegion(aggreagtion_function, gene):

      print('heatmapByRegion', aggreagtion_function, gene)
