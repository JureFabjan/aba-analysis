...
class WebInterface:
  def __init__(self, name, port = 5000):
    ...
    self.app.layout = html.Div([
        ...
        dbc.Tabs([
          dbc.Tab(self.sideBySideView(), label="Heatmap by region"),
          dbc.Tab(self.sideBySideView(), label="Stacked bars by structure, sorted"),
          dbc.Tab(self.sideBySideView(), label="Co-expressions by structure"), #, with shared variance
