...
def splitByThreshold(data, column, separation_threshold):
  return data[(data[column] < separation_threshold) & (data[column] > (-1 * separation_threshold))], data[(data[column] > separation_threshold) & (data[column] < (-1 * separation_threshold))];
