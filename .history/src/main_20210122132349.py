...
webApp = Visualisation.WebInterface('Meduni Vienna ISH & Microarray data')
...
# parameters
genes = ["Gabra4", "Gabrg3", "Gabrb3"] #["Gabra1", "Gabra2", "Gabra4", "Gabra5", "Gabrb1", "Gabrb2", "Gabrb3", "Gabrd", "Gabrg2", "Gabrg3"]
...
gabr_b3_a4 = Comparison.merge_coex(human.Gabrb3.data.structure, human.Gabra4.data.structure, ['gabrb3', 'gabra4'], ['structure_name', colorBy]).reset_index()
