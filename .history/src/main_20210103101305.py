...
#human_Gabrb3 = HumanMicroarrayData('Gabrb3').get(from_cache=from_cache, aggregations=aggregations)
#print(human_Gabrb3)

human_Gabrg3 = HumanMicroarrayData('Gabrg3').get(from_cache=from_cache, aggregations=aggregations)
mouse_Gabrg3 = MouseISHData('Gabrg3').get(from_cache=from_cache, aggregations=aggregations) 
...
h_by_region = Comparison.by_region(human['data']['structure'], 'z-score', 'level_4', 'structure_name')

FormattedExport.to_excel(h_by_region['mean'], f'export\\human_mean_pivot_agg_{geneAcronym}.xlsx')

Visualisation.heatmap(h_by_region['mean'], f'Human - {geneAcronym}, z-score (mean)', 
