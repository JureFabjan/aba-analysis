...
mouse = MouseISHData(geneAcronym).get(from_cache=False, aggregations=aggregations) 
#human = HumanMicroarrayData(geneAcronym).get(from_cache=False, aggregations=aggregations)
