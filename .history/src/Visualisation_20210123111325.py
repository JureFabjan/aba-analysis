...
class WebInterface:
  def __init__(self, name, port = 5000):
    ...
    self.app.layout = html.Div(children=[
        ...
        dcc.Input(id="genelist", type="text"),
        dcc.Dropdown(id="gene1", options=[{ "label": g, "value": g } for g in self.gene_list], multi=False, style={ 'width': "50%"}),
        dcc.Dropdown(id="gene2", options=[{ "label": g, "value": g } for g in self.gene_list], multi=False, style={ 'width': "50%"}),
