...
SPECIES = Utils.simple({ 'label': None, 'type': 'species', 'defaultLeft': 'human', 'defaultRight': 'mouse - sagittal', 'data': ['human', 'mouse - sagittal', 'mouse - coronal']})
STRUCTURE_LEVELS = Utils.simple({ 'label': 'Structure level', 'type': 'structure_level', 'defaultLeft': 2, 'defaultRight': 2, 'data': [l for l in range(0,10)] })
