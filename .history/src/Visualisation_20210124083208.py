...
class WebInterface:
  def __init__(self, name, port = 5000):
    ...
    @self.app.callback(
      [Output({'type': 'graph', 'side': 'left'}, "figure"), 
       Output({'type': 'graph', 'side': 'right'}, "figure")], 
      [Input({'type': 'aggregation_function', 'side': 'left'}, "value"), 
       Input({'type': 'gene', 'side': 'left'}, "value"), 
       Input({'type': 'gene', 'side': 'right'}, "value")])
        ...
        [
          ...
          dbc.Row([
                dbc.Col([
                  ...
                  dbc.Row(html.Div(dcc.Loading(dcc.Graph(id={ 'type': 'graph', 'view': viewName, 'side': 'left'}))), className="mt-3 w-100")
                ]),
                dbc.Col([
                  dbc.Row(
                    dbc.Form(
                  ...
                  dbc.Row(html.Div(dcc.Loading(dcc.Graph(id={ 'type': 'graph', 'view': viewName, 'side': 'right'}))), className="mt-3 w-100")
                ])
          ])
        ]
    ),
