...
class HumanMicroarrayData:
    ...
    def transformExpressionData(self, expressionData):
        ...
        data = data[data['global-z-score'].notnull()]
    ...
    def get(self, from_cache, aggregations): # load data once with use_cache = True, then change it to False to read it from disk instead of fetching it from the api
        ...
        structure_map, annotation, meta = StructureMap(reference_space_key = 'annotation/ccf_2017', resolution = 25).get(structure_graph_id=10)
        ...
        cols_to_use = data.columns.difference(structure_map.columns) 
        ...
        return Utils.merge_with_structure(data, structure_map, Utils.VALUE_COLUMNS, aggregations)
