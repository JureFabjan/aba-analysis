...
human_GABRB4 = HumanMicroarrayData('Gabrb3').get(from_cache=from_cache, aggregations=aggregations)
print(human_GABRB4)
human_GABRG4 = HumanMicroarrayData('Gabrg3').get(from_cache=from_cache, aggregations=aggregations)
print(human_GABRG4)
