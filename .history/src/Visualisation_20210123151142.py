        ...
        [
          ...
          dbc.Row([
                dbc.Col([
                  ...
                  dbc.Row(html.Div(dcc.Graph(id='left_view_container', responsive=True, config={ "fillFrame": False})), className="mt-3 w-100")
                ]),
                dbc.Col([
                  dbc.Row(html.Div(["Right view", self.dropDownByList(GENE_LIST, 'right_gene', value="Gabrg3")])),
                  dbc.Row(html.Div(dcc.Graph(id='right_view_container', responsive=True, config={ "fillFrame": False})), className="mt-3 w-100")
                ])
          ])
        ]
    ),
