...
human_GABRB4 = HumanMicroarrayData('Gabrb4').get(from_cache=False, aggregations=aggregations)
print(human_GABRB4)

human_GABRG4 = HumanMicroarrayData('Gabrg4').get(from_cache=False, aggregations=aggregations)
print(human_GABRG4)
