...
def merge(dfs, merge_on, shared_columns):
  ...
  for el in dfs:
    ...
    data = el['data'].reset_index().set_index(merge_on) # assigning this to a new var prevents mutating the original data-frames
