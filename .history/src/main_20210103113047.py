...
# print(coex_b3_a4)
gabr_b3_a4 = Comparison.merge_coex(human.Gabrb3.data.structure, human.Gabra4.data.structure, ['gabrb3', 'gabra4'])
gabr_b3_a4 = gabr_b3_a4.reset_index()[[('structure_name', ''), ('expression_level_gabrb3', 'mean'), ('expression_level_gabra4', 'mean')]] #.droplevel(1, axis=1)
Visualisation.scatter(gabr_b3_a4, x=('expression_level_gabra4', 'mean'), y=('expression_level_gabrb3', 'mean'), hue="structure_name", legend = True) #, size="weight", 
            #sizes=(40, 400), )

sys.exit()

#pd.pivot_table(, columns="structure_name").corrwith(pd.pivot_table(, columns="structure_name"))
