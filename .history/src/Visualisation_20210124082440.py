...
class WebInterface:
  def __init__(self, name, port = 5000):
    ...
    self.app.layout = html.Div([
        ...
        dbc.Tabs([
          dbc.Tab(self.sideBySideViewAllSpecies(), label="Heatmap by region"),
          dbc.Tab(self.sideBySideViewBySpecies(), label="Charts by structure and species"),
  ...
  def sideBySideViewAllSpecies(self): #, left, right): 
  ...
  def sideBySideViewBySpecies(self): #, left, right): 
    defaultClassName = "mr-3"
