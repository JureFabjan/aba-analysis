...
class MouseISHData:
    ...
    def get(self, from_cache): # load data once with from_cache = True, then change it to False to read it from disk instead of fetching it from the api
        
        from_cache = not from_cache
