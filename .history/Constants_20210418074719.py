...
AGGREGATION_FUNCTIONS = Utils.DropDownListConfiguration(label='Aggregation function', type='aggregation_function', default='mean', defaultLeft='mean',defaultRight='var', 
