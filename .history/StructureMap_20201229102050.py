...
class StructureMap:
    ...
    def get(self, structure_graph_id):
        ...
        # ! we need to use different FOLDERS for each structure-graph. else, structures.json gets overwritten by the last retrieved species. yikes...
        ...
        return structure_map.merge(ancestor_map, left_index=True, right_index=True, how="inner").sort_index()