...
def transformExpressionData(expressionData):
    ...
    data = pd.DataFrame({"expression_level": combined.expression_levels, "z-scores": combined.z_scores})
...
for index, row in sectionDataSets.iterrows(): # https://stackoverflow.com/questions/16476924/how-to-iterate-over-rows-in-a-dataframe-in-pandas
    ...
    try:
        ...
        data = pd.DataFrame({"expression_level": np.fromfile(exp_path + "energy.raw",  dtype=np.float32), "annotations": annotations})
